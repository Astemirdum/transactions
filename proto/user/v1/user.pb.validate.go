...
// ValidateAll checks the field values on SessionID with the rules defined in
// the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in SessionIDMultiError, or nil
// if none found.
func (m *SessionID) ValidateAll() error {
	return m.validate(true)
}

func (m *SessionID) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return SessionIDMultiError(errors)
	}

	return nil
}

// SessionIDMultiError is an error wrapping multiple validation errors returned
// by SessionID.ValidateAll() if the designated constraints aren't met.
...
// AllErrors returns a list of validation violation errors.
func (m SessionIDMultiError) AllErrors() []error { return m }
